...
function doSomething(scroll_pos) {
  if (window.location.pathname === '/index.html' || window.location.pathname === '/' || window.location.pathname === '/rivers-legal/index.html' || window.location.pathname === '/rivers-legal/' || window.location.pathname === '/en/index.html'  || window.location.pathname === '/es/index.html') {
    if (scroll_pos > 30) {
